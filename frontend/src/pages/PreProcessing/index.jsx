...
export const normalizationsDescriptions = [
  ...
  "The MinMaxScaler is a normalization method that scales data to a specific range, usually between 0 and 1. This is achieved by transforming the values so that the minimum value becomes 0 and the maximum value becomes 1, preserving the proportional relationship between the original data.",
  "The StandardScaler is a normalization method that transforms data so that it has a mean of zero and a standard deviation of 1. This is useful for data that follows a normal distribution and helps eliminate scale bias in machine learning algorithms.",
  "The RobustScaler is a normalization technique that is resistant to outliers. It scales data, making it robust to outliers, using robust statistics such as the median and the interquartile range.",
